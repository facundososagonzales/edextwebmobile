...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ho+j7jyWK8fNQe+A12Hb8AhRq26LrZ/JpcUGGOn+Y7RsweNrtN/tE3MoK7ZeZDyx" crossorigin="anonymous"></script>
	...
	<nav class="navbar navbar-light bg-lignt" style="background-color: #e3f2fd;">
    <a href="index.jsp" class="nav-link" style="font-size: 140%; color: #000;">Edex<span class="sr-only">(current)</span></a>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ho+j7jyWK8fNQe+A12Hb8AhRq26LrZ/JpcUGGOn+Y7RsweNrtN/tE3MoK7ZeZDyx" crossorigin="anonymous"></script>
    ...
    <div class="navbar-collapse collapse" id="collapsingNavbar2">
        <ul class="navbar-nav mx-auto">
	        ...
	        <a class="nav-link" href="consultaCursoInstCat.jsp">Consula de curso <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
	          <a class="nav-link" href="consultaEdicionCurso.jsp">Consulta de edicion de curso <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
