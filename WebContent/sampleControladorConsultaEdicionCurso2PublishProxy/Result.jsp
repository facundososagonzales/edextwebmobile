...
case 31:
        gotMethod = true;
        String arg0_4id=  request.getParameter("arg034");
...
case 36:
        gotMethod = true;
        java.lang.String[] listarEdicionCat36mtemp = sampleControladorConsultaEdicionCurso2PublishProxyid.listarEdicionCat();
if(listarEdicionCat36mtemp == null){
%>
<%=listarEdicionCat36mtemp %>
<%
}else{
        String tempreturnp37 = null;
        if(listarEdicionCat36mtemp != null){
        java.util.List listreturnp37= java.util.Arrays.asList(listarEdicionCat36mtemp);
